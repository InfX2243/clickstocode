      ...
      <div className="space-y-20 sm:space-y-28">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          <div className="lg:col-span-8 p-8 sm:p-12 rounded-3xl bg-white/[0.02] border border-white/[0.08] flex flex-col justify-between reveal-init stagger-1">
            ...
            {/* Certificate Preview Asset */}
            <div className="pt-8">
              <div className="relative aspect-[16/9] sm:aspect-[21/9] rounded-xl overflow-hidden border border-white/[0.12] bg-[#0c1017] p-2 group shadow-2xl">
                <img
                  src="/images/certificate.png"
                  alt="Digital Certificate Sample Preview"
                  className="w-full h-full object-cover rounded-lg filter contrast-105 group-hover:scale-102 transition-transform duration-500"
                />
        ...
        {/* Builder Swag Objects (Asymmetric Scale) */}
        <div className="space-y-8 reveal-init stagger-3">
          <div className="flex items-center justify-between pb-4 border-b border-white/[0.08] text-xs font-mono text-[#8e95a5] uppercase">
            ...
            <span>AWARDED AT CONCLUSION</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {SWAGS.map((swag, idx) => (
              <div
                key={idx}
                className="group border-b sm:border-b-0 sm:border-r border-white/[0.06] last:border-none pb-6 sm:pb-0 sm:pr-6 space-y-4"
              >
                <div className="aspect-[4/3] rounded-xl bg-black/40 border border-white/[0.06] overflow-hidden p-6 flex items-center justify-center">
                  <img
                    src={swag.image}
                    alt={swag.name}
                ...
                <div>
                  ...
                  <div className="text-base font-medium text-white mb-1">{swag.name}</div>
